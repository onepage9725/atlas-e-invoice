...
returns table (
  ...
  emergency_contact_ic_passport text,
...
as $$
  select
    ...
    sales_cases.customer_address,
    sales_cases.customer_details,
    sales_cases.emergency_contact_name,
    sales_cases.emergency_contact_relationship,
    sales_cases.emergency_contact_ic_passport,
    sales_cases.emergency_contact_number,
    sales_cases.emergency_contact_email,
    sales_cases.race,
